...
To support synchronous analysis tools, \xxx's checkpointer component can be invoked 
...
When a synchronous analysis tool determines that there may be a potential malicious event ahead, 
