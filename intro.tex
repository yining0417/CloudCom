...
request, and runs a PAXOS consensus protocol to ensure that a quorum of the replicas sees the same 
exact sequence of the incoming socket calls. To tackle nondeterminism, REPVM intercepts the outgoing 
syscalls in the Xen hypervisor and invokes an efficient network output checking protocl to detect 
