...
range of popular multithreaded programs. Evaluation on a widely used multimedia 
server program \mediatomb~\cite{mediatomb} with three replicas (each has 24 
cores) shows that \xxx is able to transparently run a heavyweight analysis 
tool, the Helgrind race detector~\cite{valgrind:pldi}, and a lightweight 
