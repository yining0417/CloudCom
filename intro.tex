...
% P7: benefits: fast (short response time), service is always available (VM does not need to be suspended) and general (requiring no modification on the service software) 
