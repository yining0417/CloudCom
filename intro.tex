...
applications. Typically, existing systems replicate their job 
controllers which accept job requests, allocate computational resources, and 
reschedule jobs on exceptional cases. However, the applications themselves are 
not replicated: if an application crashes or a computational resource goes down 
