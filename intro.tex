...
of replication logic. For instance, if an application submits three replicas of 
the same job to the system, the system may happen to schedule all three 
replicas on the same machine. Then, a hardware failure in this machine will 
turn down all replicas. 
