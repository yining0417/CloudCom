...
\repbox~\cite{repbox:sosp15} is the first fault-tolerance system for transparently 
replicating server applications. \xxx leverages \repbox's \paxos implementation to transparently support analysis 
